...
class User
{
    ...
    public function createUser(
        ...
        if ($userInserted) {
            $sqlInfo = "INSERT INTO user_infos (user_id, full_name, avatar_url, bio, birth_date)
                        VALUES (?, ?, ?, ?, ?)";
            ...
            $sqlAlbum = "INSERT INTO albums (album_id, album_name, description, user_id)
                         VALUES (?, ?, ?, ?)";
